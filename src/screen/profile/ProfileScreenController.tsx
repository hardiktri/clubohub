...
export default class ProfileScreenController extends Component<
  Props,
  S,
  SS
> {
  ...
  getuserdetails = async () => {
    ...
    if (responseData.status == "success") {
      ...
      this.setState({firstname:res.first_name,firstnameheader:res.first_name,
        lastnameheader:res.last_name,lastname:res.last_name,emailid:res.email,
        phonenumber:res.mobile_no,dob:res.date_of_birth,user_id:res.id,prefix:res.prefix,profile_pic:res.profile_pic})
    }
    else {
    }
  }
  updateuserdetails = async () => {
    ...
    if (responseData.status == "success") {
      ...
      this.setState({firstname:res.first_name,firstnameheader:res.first_name,
        lastnameheader:res.last_name,lastname:res.last_name,emailid:res.email,
        phonenumber:res.mobile_no,dob:res.date_of_birth,user_id:res.id,prefix:res.prefix,isedit:false,profile_pic:res.profile_pic})
