...
import EventBookingsListController, {
  Props,
} from './EventBookingsListController';
...
export default class EventBookingsList extends EventBookingsListController {
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            <View style={{flex: 1}}>
              {this.state.eventBookingList.length > 0 ? (
                <FlatList
                  data={this.state.eventBookingList}
                  scrollEnabled={false}
