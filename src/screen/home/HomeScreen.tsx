...
import { showToast, showtoasterror, showtoastsucces } from '../../globalServices/utils';
          ...
          <View
              ...
              <SelectDropdown
                ...
                buttonTextAfterSelection={(selectedItem, index) => {
                  if (selectedItem.id !== this.state.selectedClubDetails.id) {
                    ...
                    this.getEvents(selectedItem.id);
                  }
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              <TouchableOpacity style={{}}
                ...
                {
                  this.state.ShownotificationDot &&
                  <View style={{ height: 10, width: 10, backgroundColor: 'red', borderRadius: 5, position: 'absolute', right: -4, top: -3, zIndex: 1 }} />
                }
          ...
          <ScrollView
            ...
            <View>
              <View style={{ flexDirection: 'row' }}>
                <Text style={[styles.headtext, { flex: 1 }]}>Club Details</Text>
            ...
            <View>
              <View style={{ flexDirection: 'row', marginTop: 20 }}>
                <Text style={[styles.headtext, { flex: 1 }]}>Top Activities</Text>
                <TouchableOpacity
                  onPress={() =>
            ...
            <View>
              <View style={{ flexDirection: 'row', marginTop: 10 }}>
                <Text style={[styles.headtext, { flex: 1 }]}>Top Events</Text>
                <TouchableOpacity
              ...
              <View style={{ height: 200 }}>
                <FlatList
                  ...
                  renderItem={({ item, index }) => (
                    <TouchableOpacity activeOpacity={0.9} style={{ paddingEnd: 10 }}
                      onPress={() =>
